				...
				$('#memberList').append(						
					'<tr data-id="' + _len + '">' +
						...
						'<td class="td-manage">'+
							...
							'<a title="编辑" onclick="WeAdminShow(\'编辑\',editedit.jsp400)" href="javascript:;"><i class="layui-icon">&#xe642;</i></a>'+
							'<a onclick="WeAdminShow(\'修改密码\',passpassword.jsp400)" title="修改密码" href="javascript:;"><i class="layui-icon">&#xe631;</i></a>'+
